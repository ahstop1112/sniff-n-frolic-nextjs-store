...
"[project]/src/lib/woo/server.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/wooClient.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$woo$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/woo/server.ts [app-route] (ecmascript)");
...
const wooFetch = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$woo$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["wooFetchServer"];
const getProducts = async (options)=>{
    ...
    return wooFetch("/products", {
        ...
        next: {
            revalidate: isSearch ? 0 : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CACHE_CONFIG"].PRODUCTS
        }
    });
};
const getProductBySlug = async (slug)=>{
    const products = await wooFetch("/products", {
        ...
        next: {
            revalidate: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CACHE_CONFIG"].PRODUCT_DETAIL
        }
    });
...
const getCategories = async (options)=>{
    return wooFetch("/products/categories", {
        ...
        next: {
            revalidate: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CACHE_CONFIG"].CATEGORIES
        }
    });
};
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$wooClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/wooClient.ts [app-route] (ecmascript)");
;
;
const GET = async ()=>{
    try {
        const categories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$wooClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCategories"])({
            hide_empty: true
        });
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("Failed to fetch categories", {
            status: 500
        });
    }
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d6056e9c._.js.map